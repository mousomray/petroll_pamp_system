...
const { createPurchase, listPurchases,getPurchaseDetails,updatePurchase,generatePurchaseInvoice } = require("../controller/purchase.controller.js")
...
router.get("/generate-purchase-invoice/:id", verifyJwt, authorize("ADMIN"), generatePurchaseInvoice)
