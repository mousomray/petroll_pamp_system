...
const { createShiftWiseSales, createSalesForAccessory,getSalesList,generateSalesInvoice } = require("../controller/sales.controller.js")
...
router.get("/generate-sales-invoice/:id", verifyJwt, authorize("ADMIN"), generateSalesInvoice)
